...
-define(AGENT_THRESHOLD, 25). %% TODO zmienna powinna byc konfigurowana przez usera i na dodatek zalezna od interakcji
...
handle_call({interact,Agent}, From, State) ->
    ...
    case length(Waitlist)  of
        ?AGENT_THRESHOLD ->
            NewAgents = aud_agent:incrementIterations(misc_util:meeting_proxy({State#state.interaction,Waitlist},concurrent)),
